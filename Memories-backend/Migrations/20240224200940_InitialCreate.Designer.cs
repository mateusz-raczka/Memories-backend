...
namespace Memoriesbackend.Migrations
{
    ...
    [Migration("20240224200940_InitialCreate")]
            ...
            modelBuilder.Entity("Memories_backend.Models.Domain.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1b16515f-2e32-45c5-b909-baff650edb41"),
                            Name = "Edit"
                        },
                        new
                        {
                            Id = new Guid("3451a306-1260-4a18-90ee-8f2d57abec59"),
                            Name = "Share"
                        },
                        new
                        {
                            Id = new Guid("7ded3d5f-eedb-46f9-b8cc-1e047684df3d"),
                            Name = "Transfer"
                        },
                        new
                        {
                            Id = new Guid("5da05bc3-84b2-4acb-ad49-359044cf2d41"),
                            Name = "Create"
                        },
                        new
                        {
                            Id = new Guid("8629a3b9-ae58-4b92-bd0c-9c25ece0e123"),
                            Name = "Delete"
                        },
                        new
                        {
                            Id = new Guid("da1ba639-0e9c-4f93-9d21-cdd5713ad24b"),
                            Name = "Open"
                        });
                });
