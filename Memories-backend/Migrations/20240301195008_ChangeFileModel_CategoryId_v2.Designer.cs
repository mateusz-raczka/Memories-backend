...
namespace Memoriesbackend.Migrations
{
    ...
    [Migration("20240301195008_ChangeFileModel_CategoryId_v2")]
    partial class ChangeFileModelCategoryIdv2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Memories_backend.Models.Domain.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dabccd5b-37ce-4c5d-8489-b157e8ed0dbd"),
                            Name = "Edit"
                        },
                        new
                        {
                            Id = new Guid("8a88de3b-ab7d-4740-a782-1580d6945474"),
                            Name = "Share"
                        },
                        new
                        {
                            Id = new Guid("c99e5150-e895-4ef5-8136-6b39689d8ccf"),
                            Name = "Transfer"
                        },
                        new
                        {
                            Id = new Guid("664e8143-d984-415b-948a-b224473b9b4c"),
                            Name = "Create"
                        },
                        new
                        {
                            Id = new Guid("eb93e4a8-5f5c-441d-862b-e85de8419fd3"),
                            Name = "Delete"
                        },
                        new
                        {
                            Id = new Guid("5a634db2-f3a6-4615-aaa7-2e953570c748"),
                            Name = "Open"
                        });
                });
