...
namespace Memoriesbackend.Migrations
{
    ...
    [Migration("20240227212540_ChangeFileModel_CategoryId")]
    partial class ChangeFileModelCategoryId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Memories_backend.Models.Domain.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f55a0907-f2de-43ee-8d1a-4fe2717feb10"),
                            Name = "Edit"
                        },
                        new
                        {
                            Id = new Guid("6e2aabcb-17a9-437e-b08b-641a9f70672e"),
                            Name = "Share"
                        },
                        new
                        {
                            Id = new Guid("9dc6be93-197b-4d41-84e2-83076625b79d"),
                            Name = "Transfer"
                        },
                        new
                        {
                            Id = new Guid("e8251f01-3e02-42a5-8b7d-fa4009576e25"),
                            Name = "Create"
                        },
                        new
                        {
                            Id = new Guid("7363a8e8-6901-4cf2-9420-187cdb770616"),
                            Name = "Delete"
                        },
                        new
                        {
                            Id = new Guid("ef0d6a85-9045-479b-b023-80ed8cb5d070"),
                            Name = "Open"
                        });
                });
